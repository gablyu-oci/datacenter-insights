...
export default function TSMCTab() {
  const { data, loading } = useApi<TSMCResponse>("/api/tsmc");
  ...
  const latestPkg = packaging[packaging.length - 1];
    ...
    <div style={{ padding: "24px", display: "flex", flexDirection: "column", gap: "20px" }}>
      ...
      <div style={{ display: "flex", gap: "16px", flexWrap: "wrap" }}>
        {[
          ...
          { label: "Fab Utilization", value: `${latest?.utilization_pct ?? 0}%`, unit: "", color: latest?.utilization_pct > 90 ? "#f59e0b" : "#22c55e" },

...
Calibration knob:
    AI_INSIGHTS_SYSTEM_INJECTION_MODE
        ...
        "user-shaped"   — wrap as a {role:"user"} message with [SYSTEM]/[/SYSTEM]
                          markers (fallback when calibration shows the model
                          does not honour mid-turn system messages)

The calibration helper in ./calibration.py picks the mode and exports it
as an env var at startup.
"""
